...
def MakeAtomInfos():
    ...
    for At in "Na Mg Al Si P S Cl Ar".split(): nCoreX[At] = 5
    for At in "K Ca".split(): nCoreX[At] = int(18/2)
    for At in "Sc Ti V Cr Mn Fe Co Ni Cu Zn".split(): nCoreX[At] = int(18/2)
    for At in "Ga Ge As Se Br Kr".split(): nCoreX[At] = int(18/2)+5 # [Ar] and the 5 d orbitals.
    nAoX = {"H": 1, "He": 1}
    ...
    for At in "K Ca".split(): nAoX[At] = int(18/2)+1
    for At in "Sc Ti V Cr Mn Fe Co Ni Cu Zn".split(): nAoX[At] = int(18/2)+1+5   # 4s, 3d
    for At in "Ga Ge As Se Br Kr".split(): nAoX[At] = int(18/2)+1+5+3
